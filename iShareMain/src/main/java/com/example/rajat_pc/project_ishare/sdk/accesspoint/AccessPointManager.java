package com.example.rajat_pc.project_ishare.sdk.accesspoint;
...
public class AccessPointManager extends WifiManagerWrap
{
    ...
    /**
     * Get Wifi Hotspot configuration
     * 
    ...
    public boolean setHTCSSID(WifiConfiguration config)
    {
        ...
        try
        {
            ...
            if (localoObject1 != null)
            {
                ...
                //Open do not add wpa2-psk wpa-psk we use wpa-psk way encryption and previous versions compatible wap-psk for wep way encryption, open not encrypted
    ...
    public String getWiFiHotSpotGate()
    {
        ...
        try
        {
            ...
            if (gateString == null)
                gateString = Constant.FREE_SERVER; //Temporarily write dead. Polling the way that the gateway address will be null (sometimes)
        }
    ...
    /**
     * wifi AP network status listener
     */
