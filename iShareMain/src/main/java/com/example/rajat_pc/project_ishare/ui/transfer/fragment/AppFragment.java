package com.example.rajat_pc.project_ishare.ui.transfer.fragment;
...
import com.example.rajat_pc.project_ishare.ui.transfer.view.AppSelectAdapter;
import com.example.rajat_pc.project_ishare.ui.uientity.AppInfo;
import com.example.rajat_pc.project_ishare.ui.uientity.IInfo;
import com.example.rajat_pc.project_ishare.ui.view.MyWindowManager;
import com.example.rajat_pc.project_ishare.utils.DeviceUtils;
import com.example.rajat_pc.project_ishare.utils.ViewUtils;
        ...
        OnSelectItemClickListener
{
    ...
    private AppInfo getAppInfo(ApplicationInfo app)
    {
        ...
        //This place can not be changed
        // Not a space
        // Do not know anything！！！
        //String label = ((String)app.loadLabel(pkManager)).replace(" ","") + ".apk";
        String label = DeviceUtils.removeSpecial((String) app.loadLabel(pkManager)) + ".apk";
