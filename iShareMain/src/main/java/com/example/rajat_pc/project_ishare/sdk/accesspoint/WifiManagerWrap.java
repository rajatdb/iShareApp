...
public class WifiManagerWrap
{
    ...
    /**
     * Set whether the mobile network is allowed to open
     * 
     * @param context Context
     * @param enabled Whether to allow the mobile network to be opened
     */
    ...
    /**
     * Gets whether the current mobile network is open
     * 
     * @param context Context
     * @return Whether the mobile network is open
     */
