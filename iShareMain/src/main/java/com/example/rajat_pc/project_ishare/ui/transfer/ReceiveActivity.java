package com.example.rajat_pc.project_ishare.ui.transfer;
...
import com.example.rajat_pc.project_ishare.constant.Constant;
import com.example.rajat_pc.project_ishare.sdk.accesspoint.AccessPointManager;
...
import com.example.rajat_pc.project_ishare.ui.transfer.view.FileTransferAdapter;
import com.example.rajat_pc.project_ishare.ui.view.CommonProgressDialog;
import com.example.rajat_pc.project_ishare.utils.NetworkUtils;
import com.example.rajat_pc.project_ishare.utils.ToastUtils;
...
import com.example.rajat_pc.p2pmanager.p2pinterface.Melon_Callback;
import com.example.rajat_pc.p2pmanager.p2pinterface.ReceiveFile_Callback;
import com.example.rajat_pc.randomtextview.RandomTextView;
import com.example.rajat_pc.rippleoutlayout.RippleOutLayout;
        ...
        AccessPointManager.OnWifiApStateChangeListener
{
    ...
    private void initP2P()
    {
        ...
        p2PManager.receiveFile(new ReceiveFile_Callback()
        {
            ...
            {
                ToastUtils.showTextToast(getApplicationContext(), getString(R.string.file_receive_completed));
                finish();
            }
            ...
            public void AbortReceiving(int error, String name)
            {
                switch (error)
                {
                    case P2PConstant.CommandNum.SEND_ABORT_SELF :
                        ToastUtils.showTextToast(getApplicationContext(),getString(R.string.send_abort_self));
                        finish();
                        break;
                }
            }
