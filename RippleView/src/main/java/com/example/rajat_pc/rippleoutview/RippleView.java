package com.example.rajat_pc.rippleoutview;
...
public class RippleView extends TextView
{
    ...
    /**
     * The minimum value of the default ripple
     */
    private int mMinSize = 200;
    /**
     * Whether the ripple animation effect is in progress
     */
    ...
    /**
     * //Infinite length of the value, so that the animation does not stop
     */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        Log.d(tag, "ripple out view radius = " + mRadius + "; width =" + resultWidth + "; height = " + resultHeight);
