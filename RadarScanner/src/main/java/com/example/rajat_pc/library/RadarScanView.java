package com.example.rajat_pc.library;
...
public class RadarScanView extends View
{
    ...
    private void init(AttributeSet attrs, Context context)
    {
        ...
        initPaint();
        //Gets the pixel width of the current screen
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        //Set the color gradient from transparent to opaque
        //Shader shader = new SweepGradient(centerX, centerY, Color.TRANSPARENT, tailColor);
        Shader shader = new SweepGradient(centerX, centerY, Color.parseColor("#00A8D7A7"), Color.parseColor("#ffA8D7A7"));
